    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
    {
        ...
        Connection con=DB_Connection.get_DBConnection();
            ...
            if(rs1.next())
            {
                ...
                t=t+"<div style='font-size: 20px;font-weight:lighter;padding-top:3px;'>Quick Overview</div> <div style='font-size: 15px'>"+rs1.getString("description")+"</div><div style='padding-top:3px;font-weight:bold'>Company: "+rs1.getString("company")+" </div><div style='padding-top:3px;padding-bottom:10px'>Type:"+rs1.getString("type")+"</div></div>";;
                t=t+"</div>";
                t=t+"<div class='row'>";
