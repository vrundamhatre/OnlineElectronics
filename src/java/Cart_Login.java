    ...
    public String create_cart(HttpServletRequest req,HttpServletResponse res,PrintWriter pw)
    {
        ...
        while(e.hasMoreElements())
        {
            ...
            if(n.charAt(0)=='E')
            {
                ...
                t=t+"<div style='font-size: 18px;font-weight:lighter;padding-top:3px;'>Quick Overview</div> <div style='font-size: 15px'>"+rs1.getString("description")+"</div><div style='padding-top:3px;'>Company: "+rs1.getString("company")+" </div><div style='padding-top:3px;padding-bottom:10px'>Type:"+rs1.getString("type")+"</div></div>";;
        ...
        t=t+"<br/><div class='row pull-left'><a href='payment.jsp?emailid="+emailid+"&mobile="+mobile+"&grandtotal="+total+"'id='btn_checkout' class='btn btn-primary' style='width:100%'><i class='fa fa-credit-card'></i> Make Payment</a></div><div style='position:fixed;bottom:0px;width:100%;'><jsp:include page='footer.jsp'/></div>";
